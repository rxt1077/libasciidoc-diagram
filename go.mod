module github.com/rxt1077/libasciidoc-diagram

go 1.11

require (
	github.com/alecthomas/chroma v0.7.1
	github.com/bytesparadise/libasciidoc v0.6.0 // indirect
...
replace github.com/bytesparadise/libasciidoc v0.6.0 => ../libasciidoc
